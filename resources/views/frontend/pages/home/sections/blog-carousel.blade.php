<section class="blog_4 mt_110 xs_mt_90 pt_120 xs_pt_100 pb_120 xs_pb_100">
    ...
    <div class="row blog_4_slider">
        <div class="col-xl-4 wow fadeInUp">
            <div class="wsus__single_blog_4">
                <a href="#" class="wsus__single_blog_4_img">
                    <img src="frontend/assets/images/blog_4_img_1.jpg" alt="Blog" class="img-fluid">
                    <span class="date">March 23, 2024</span>
                </a>
                <div class="wsus__single_blog_4_text">
                    <ul>
                        <li>
                            <span><img src="frontend/assets/images/user_icon_black.png" alt="User"
                                    class="img-fluid"></span>
                            By Richard Tea
                        </li>
                        <li>
                            <span><img src="frontend/assets/images/comment_icon_black.png" alt="Comment"
                                    class="img-fluid"></span>
                            3 Comments
                        </li>
                    </ul>
        ...
        <div class="col-xl-4 wow fadeInUp">
            <div class="wsus__single_blog_4">
                <a href="#" class="wsus__single_blog_4_img">
                    <img src="frontend/assets/images/blog_4_img_2.jpg" alt="Blog" class="img-fluid">
        ...
        <div class="col-xl-4 wow fadeInUp">
            <div class="wsus__single_blog_4">
                <a href="#" class="wsus__single_blog_4_img">
                    <img src="frontend/assets/images/blog_4_img_3.jpg" alt="Blog" class="img-fluid">
        ...
        <div class="col-xl-4 wow fadeInUp">
            <div class="wsus__single_blog_4">
                <a href="#" class="wsus__single_blog_4_img">
                    <img src="frontend/assets/images/blog_4_img_4.jpg" alt="Blog" class="img-fluid">
                    <span class="date">April 28, 2024</span>
                </a>
                <div class="wsus__single_blog_4_text">
                    <ul>
