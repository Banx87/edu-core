                                        ...
                                        <div id="collapseOne4409" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a class="dropdown-item" href="#">Resources File
                                                                01</a>
                                                        </li>
                                                        <li>
                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p>
                                                    You know the latest laravel version is now Laravel
                                                    9. So we have created a very complete course on
                                                    Laravel 9.
                                                </p>
                                                <p>
                                                    If you are new to Laravel or beginner to Laravel,
                                                    you will be able to learn it in advanced level from
                                                    this course.
                                                </p>
                                                <p><b>Here we have taught the students:</b></p>
                                                <ul>
                                                    <li>
                                                        Composer - Installing composer in local machine.
                                                    </li>
                                                    <li>
                                                        MVC (Model, View, Controller) - How it works and
                                                        details.
                                                    </li>
                                                    <li>
                                                        Laravel 9 Installation - Installation process,
                                                    </li>
                                                    <li>
                                                        Route - Basic route, route parameter, route group
                                                    </li>
                                                    <li>
                                                        Middleware - How it works, types of middleware
                                                    </li>
                                                    <li>
                                                        Controller - Basic controller, partial and
                                                        resource
                                                    </li>
                                                    <li>
                                                        View - view features (extends, include, yield,
                                                        section)
                                                    </li>
                                                </ul>
                                            </td>
                                    ...
                                    <div class="video_qna_list_item">
                                        ...
                                        <div class="text">
                                            <a class="qna_title" href="#">mailtrap.io doe not send email
                                                ...
                                                to the user's email?</a>
                                            <p>
                                                Hi, how do I make mailtrap.io send the email
                                                verification directly to the user's email?
                                            </p>
                                            <ul>
                            ...
                            <div class="qna_details_area">
                                ...
                                <div class="qns_details_list_item video_qna_list_item">
                                    ...
                                    <div class="text">
                                        ...
                                        <p>
                                            Thank you for the insight. Please tell me how to
                                            implement direct-to-user mail verification.
                                        </p>
                                        <div class="dot">
                        ...
                        <div class="video_review">
                            ...
                            <div class="course-review-head">
                                ...
                                <div class="review-author-content">
                                    ...
                                    <p>
                                        ...
                                        malesuada tortor non turpis semper bibendum nisi porta,
                                        malesuada risus nonerviverra dolor. Vestibulum ante ipsum
                                        primis in faucibus.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="video_review_input">
                                ...
                                <form action="#">
                                    ...
                                    <button type="submit" class="btn arrow-btn back_qna_list">
                                        Submit
                                    </button>
                                </form>
                            </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                ...
                                <b>{{ $chapter->title }}</b>
                                <span>5/{{ count($chapter->lessons) }}</span>
                            </button>
                        </h2>
                        <div id="collapse-{{ $chapter->id }}" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body lesson_list">
                                ...
                                {{-- <div class="dropdown">
                                    ...
                                    <ul>
                                        <li>
                                            <a class="dropdown-item" href="#">Resources File 01</a>
                                        </li>
