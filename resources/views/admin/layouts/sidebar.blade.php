     ...
     <aside class="navbar navbar-vertical navbar-expand-lg no-print" data-bs-theme="dark">
         <div class="container-fluid">
             ...
             <h1 class="navbar-brand navbar-brand-autodark">
                 <a href=".">
                     <img src="{{ config('settings.site_logo') }}" width="110" height="32" alt="Logo"
                 ...
                 <div class="nav-item d-none d-lg-flex me-3">
                     <div class="btn-list">
                         ...
                         <a href="https://github.com/sponsors/codecalm" class="btn" target="_blank" rel="noreferrer">
                             <svg class="icon text-pink" width="24" height="24" viewBox="0 0 24 24"
                                         ...
                                         <div class="row align-items-center">
                                             ...
                                             <div class="col-auto">
                                                 <a href="#" class="list-group-item-actions">
                                                     <svg class="icon text-muted" width="24" height="24"
