...
$(function () {
	...
	$(".dynamic_modal_btn").on("click", function (e) {
		...
		$.ajax({
			...
			url:
				base_url +
				"/admin/course-content/:id/create-chapter".replace(":id", course_id),
			data: {},
			beforeSend: function () {
	...
	$(".edit_chapter").on("click", function (e) {
		...
		$.ajax({
			...
			url:
				base_url +
				"/admin/course-content/:id/edit-chapter".replace(":id", chapter_id),
			data: {},
			beforeSend: function () {
				$(".dynamic-modal-content").html(loader);
			},
	...
	if ($(".sortable_list li").length) {
		$(".sortable_list").sortable({
			...
			update: function (event, ui) {
				...
				$.ajax({
					method: "POST",
					url: base_url + `/admin/course-content/${chapterId}/sort-lesson`,
					data: {
						_token: csrf_token,
						order_ids: orderIds,
					},
